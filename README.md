...
- **Theme apply boundary** — `chroma` invokes a configured
  ...
  home-manager) that handles dconf, GTK ini, ghostty config, OSC
  sequences, emacsclient, and fzf colors. The daemon stays
  NixOS-agnostic; the apply script stays NixOS-specific.
